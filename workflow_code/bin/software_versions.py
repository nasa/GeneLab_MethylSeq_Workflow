...
CONFIG = {
    "methylseq": [
        ["NF_MethylSeq", "https://github.com/nasa/GeneLab_Data_Processing/tree/master/Methyl-Seq"],
        ...
        ["pandas", "https://github.com/pandas-dev/pandas"] # Add yaml and pandas to pipeline doc or remove here?
    ]
}
...
def main(versions_json_path: Path, output_path: Path, assay: str = 'methylseq', workflow: str = None, workflow_version: str = None):
...
if __name__ == "__main__":
    ...
    @click.option('--assay', type=click.Choice(['methylseq']), default='methylseq')
